# cart=["water", "wheat", "sugar", "chicken", "beef"]
# print(cart[0])
...
book1 = (11111, "Pride and Prejudice", "Jane Austen", 1813)
book2 = (22222, "Moby Dick", "Herman Melville", 1851)
book3 = (33333, "The Catcher in the Rye", "J.D. Salinger", 1951)

library = [book1, book2, book3]

serch_id = int(input("Enter the book ID: "))
found = False
